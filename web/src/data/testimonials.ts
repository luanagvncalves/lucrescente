...
export const testimonials: Testimonial[] = [
  {
    ...
    product: "spray relax, roll-on relaxante e batom para herpes",
    productTranslations: { en: "relax spray, relaxing roll-on and cold sore lip balm", fr: "spray relax, roll-on relaxant et baume à lèvres pour bouton de fièvre" },
    stars: 5,
    year: 2026,
  },
  {
  ...
  },
  {
    ...
    product: "roll-on respiratório",
    productTranslations: { en: "respiratory roll-on", fr: "roll-on respiratoire" },
    stars: 5,
    year: 2025,
  },
  {
  ...
  },
  {
    ...
    product: "roll-on dores de cabeça",
    productTranslations: { en: "headache roll-on", fr: "roll-on maux de tête" },
    stars: 5,
    year: 2025,
  },
  {
  ...
  },
  {
    ...
    product: "bálsamo labial e sabonete de rosto",
  ...
  },
  {
    ...
    product: "desodorizante lavanda/palmarosa e erva-príncipe/tea tree",
    productTranslations: {
  ...
  },
  {
    ...
    productTranslations: {
      en: "hair-strengthening / hair-loss prevention shampoo (in development)",
      fr: "shampoing fortifiant / anti-chute (en développement)",
    },
    stars: 5,
  },
  {
  ...
  },
  {
    ...
    product: "amaciador / condicionador sólido",
    productTranslations: { en: "solid conditioner", fr: "après-shampoing solide" },
    stars: 5,
  },
  {
