...
export const en: Dictionary = {
  ...
  checkout: { ...pt.checkout, title: "confirm order", summary: "order summary", shippingTo: "shipping to",  paymentMethod: "payment method",  paymentNote: "you can pay by card, MB WAY or apple pay — you choose on the next step, on Stripe's secure page.",     continuePayment: "continue to payment", subtotal: "subtotal", shipping: "shipping", total: "total", backToCart: "back to cart" },
